...
/*   Updated: 2021/08/27 18:35:18 by nouchata         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	builtin_dispatcher(t_execdata *d, t_varenv *ve)
{
	...
	if (d && !ft_strncmp(d->cmd[0], "pwd", 0))
		return (builtin_pwd(d));
	...
	if (d && !ft_strncmp(d->cmd[0], "exit", 0))
		return (builtin_exit(ve->minishell_var, &d->cmd[1]));
	if (d && (!ft_strncmp(d->cmd[0], "export", 0) || \
	!ft_strncmp(d->cmd[0], "unset", 0) || !ft_strncmp(d->cmd[0], "cd", 0)))
	{
